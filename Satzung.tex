...
\begin{contract}
  \begin{multicols}{2}
    ...
    Aktive Ordentliche Mitglieder gemäß \refL{C:Mitglieder} \refL{S:OrdentlicheMitglieder:Erwachsene} und \refL{S:OrdentlicheMitglieder:Jugendliche} der Satzung sind verpflichtet,
    an der Vereinsarbeit teilzunehmen.
    
    \Clause{title={Rechte der Mitglieder}}
    
    Die aktiven ordentlichen Mitglieder gemäß \refL{C:Mitglieder} \refL{S:OrdentlicheMitglieder:Erwachsene} und \refL{S:OrdentlicheMitglieder:Jugendliche}
