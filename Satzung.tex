...
\begin{contract}
  \begin{multicols}{2}
    ...
    \label{C:ErlöschenDerMitgliedschaft}
    ...
    \end{itemize}
    ,deren Funktionen im Innenverhältnis in einer vom Ausschuss erlassenen Geschäftsordnung zu regeln sind.
    ...
    \begin{enumerate}[label=\alph*),noitemsep]
      ...
      \item Ausschluss gemäß \refClauseL{C:ErlöschenDerMitgliedschaft}~\autoref{S:Ausschluss}
