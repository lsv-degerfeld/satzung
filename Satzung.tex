...
\begin{contract}
  \begin{multicols}{2}
    ...
    \begin{enumerate}[label=\alph*),noitemsep]
      ...
      \item Ersatz der während der Amtszeit ausscheidenden Mitglieder des Ausschusses (ohne Vorsitzenden und 1.stellvertretendem Vorsitzenden) bis zur nächsten Hauptversammlung.
    ...
    Startwinden,
    Fahrzeuge,
    Nachrichtenmittel und Hilfsgeräte geschehen unter Verantwortung des technischen Leiter.
    ...
    \begin{enumerate}[label=\alph*),noitemsep]
      ...
      \item Entlastung des vertretungsber. Vorstandes nach i.S. des §26 BGB (\autoref{S:Vorstandsmitglieder})
