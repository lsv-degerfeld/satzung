...
\section*{Art der Gegenüberstellung}
  ...
  \todo[inline]{Technische/n Leiter. Das wird mal ein Einzahl, mal in Mehrzahl geschrieben. An einigen Stellen ist es durch das hinzufügen von /n gelöst, an anderen Stellen müssen jedoch ganze Sätze umgebaut werden. Vermutlich wurde das mal geändert aber inkonsequent nur an den einfachen Stellen. Soll das so bleiben oder soll das einheitlich werden? Wenn ja, wie? Einzahl oder Mehrzahl? Wenn in Mehrzahl, müssten deutlich mehr Absätze angepasst werden. Wenn in Einzahl, müssten die Absätze mit /n angepasst werden.}
  ...
  \todo[inline]{Der Technischen Leiter weiter anschauen, überall ändern oder zurück auf Einzahl??}
  ...
  Diese Regelung ist angelehnt an vergleichbare Regeln in anderen Flugsportvereinen wie beispielsweise dem Luftsportring Aalen e.V.\footnote{https://www.lsr-aalen.de/images/besucher/allgemeines/verein/lsr\_satzung\_2020.pdf} oder dem \todo[inline]{hier weitere Vereine einfügen}.
...
Die Streichung ist dem Mitglied schriftlich mitzuteilen.}
  ...
  \label{sec:vorstand}
  \todo[inline]{Introtext}
  \todo[inline]{Änderungen gegenüberstellen}
