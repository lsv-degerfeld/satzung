...
%DIF ADD Satzung.tex       Thu Nov 23 12:35:03 2023
...
%DIFDELCMD <     %%%
\DIFdelend \DIFaddbegin \DIFadd{Die zwei weiteren stellvertretenden Vorsitzenden werden bei Bedarf durch den Auschuss berufen und gewählt.
    }
...
\DIFdel{4 Beisitzer
    ...
    Der \DIFdelbegin \DIFdel{Ausschuß }\DIFdelend \DIFaddbegin \DIFadd{Ausschuss }\DIFaddend und damit auch der Vorstand werden \DIFdelbegin \DIFdel{auf zwei Jahre }\DIFdelend \DIFaddbegin \DIFadd{von der Mitgliederversammlung auf die Dauer von zwei Jahren,
    vom Tage der Wahl an gerechnet, }\DIFaddend gewählt.
    \DIFaddbegin \DIFadd{Er bleibt jedoch bis zur Neuwahl des Ausschusses beziehungsweise des Vorstandes im Amt.
    ...
    wenn \DIFdelbegin \DIFdel{einschließlich des Vorstandes }\DIFdelend \DIFaddbegin \DIFadd{ein Vorsitzender oder Stellvertreter und }\DIFaddend mehr als die Hälfte der Mitglieder anwesend sind.
...
\DIFdelend \DIFaddbegin \Clause{title={Der/Die Technische/n Leiter}}
    ...
    \DIFaddbegin \DIFadd{Der Vorsitzende hat diese Frist mit angemessener Frist den Mitgliedern mitzuteilen.
    }\DIFaddend 
    ...
    \DIFadd{Wählbar sind nur Mitglieder, die das vierzigste Lebensjahr vollendet haben, mindestens zehn Jahre dem Verein und nicht dem Vorstand angehören.
}
